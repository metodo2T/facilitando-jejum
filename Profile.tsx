...
interface ProfileProps {
  user: { id: string; name: string; protocol: string; photoURL?: string; memberSince?: string } | null;
  onLogout: () => void;
  updateUser?: (updates: Partial<{ name: string, protocol: string, photoURL: string }>) => void;
}
